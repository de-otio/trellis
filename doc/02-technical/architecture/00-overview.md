...
- **Regional expansion** — expansion into additional regulatory regions is a future requirement; architecture must not preclude data residency / localisation but need not implement it now.
