...
Estimates for max traffic/users Trellis can handle with a properly configured in-process `pg.Pool`, based on the architecture in [aws-ecs-database-connections.md](aws-ecs-database-connections.md).
