...
This document provides detailed specifications for the cryptographic protocols used in the secure voting system. The system implements end-to-end verifiable voting using ElectionGuard-compatible protocols.
...
Break the link between voter identity and vote content through cryptographic mixing (adopted from Estonia).
...
Allow voters to verify that their ballot was encrypted correctly without revealing their vote to the system.
...
- Quantum computers may break current encryption in 10-30 years

### Migration Strategy

**Hybrid Approach**:

1. **Phase 1 (Current)**: Classical ElGamal encryption
2. **Phase 2 (Transition)**: Hybrid classical/post-quantum schemes
   - Use both classical and post-quantum encryption
   - Maintain backward compatibility
3. **Phase 3 (Future)**: Full post-quantum cryptography
...
- Plan migration when standards mature
- Test hybrid schemes in non-critical elections first
- Full migration when post-quantum homomorphic encryption available
