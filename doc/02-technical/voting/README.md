...
>
> **Moved 2026-05-25:** Relocated from the consumer-vertical repo's `doc/01-business/features/b2c-features/voting/` into the Trellis generic core. The voting feature is generic infrastructure used by every Trellis tenant, not a vertical-specific feature. See [analysis/monetization/value-exchange-social-platform/15-platform-as-city/08-secure-voting.md](../../../analysis/monetization/value-exchange-social-platform/15-platform-as-city/08-secure-voting.md) for the framing argument.
