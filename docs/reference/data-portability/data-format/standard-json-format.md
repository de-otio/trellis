...
description: Complete field-by-field specification for the standard JSON user data export.
sidebar: Standard JSON Format
order: 20
---

# Standard JSON Format

This document describes the standard JSON format for user data exports. This
format is human-readable and suitable for general-purpose use.
