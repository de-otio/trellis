---
title: Export Format Validation
description: Required fields and validation rules for Trellis user data exports.
sidebar: Validation
order: 50
---
...
The export format follows a structured JSON layout. For strict validation, consider:
